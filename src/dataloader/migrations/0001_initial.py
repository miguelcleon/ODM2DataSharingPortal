# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-05-15 08:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('relation_id', models.AutoField(db_column='relationid', primary_key=True, serialize=False)),
                ('annotation', models.ForeignKey(db_column='annotationid', on_delete=django.db.models.deletion.CASCADE, related_name='related_annonation_annotation', to='dataloader.Annotation')),
                ('related_annotation', models.ForeignKey(db_column='relatedannotationid', on_delete=django.db.models.deletion.CASCADE, related_name='related_annotation_related_annontation', to='dataloader.Annotation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_set', models.ForeignKey(db_column='datasetid', on_delete=django.db.models.deletion.CASCADE, related_name='related_dataset_dataset', to='dataloader.DataSet')),
                ('related_data_set', models.ForeignKey(db_column='relateddatasetid', on_delete=django.db.models.deletion.CASCADE, related_name='related_dataset_related_dataset', to='dataloader.DataSet')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('relation_id', models.AutoField(db_column='relationid', primary_key=True, serialize=False)),
                ('model', models.ForeignKey(db_column='modelid', on_delete=django.db.models.deletion.CASCADE, related_name='related_model_model', to='dataloader.Model')),
                ('related_model', models.ForeignKey(db_column='relatedmodelid', on_delete=django.db.models.deletion.CASCADE, related_name='related_model_related_model', to='dataloader.Model')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='variable',
            name='speciation',
            field=models.ForeignKey(blank=True, db_column='speciationcv', null=True, on_delete=django.db.models.deletion.CASCADE, to='dataloader.Speciation'),
        ),
        migrations.AddField(
            model_name='variable',
            name='variable_name',
        ...
        migrations.AddField(
            ...
            name='related_result',
            field=models.ForeignKey(db_column='relatedresultid', on_delete=django.db.models.deletion.CASCADE, related_name='related_result_related_result', to='dataloader.Result'),
        ),
        migrations.AddField(
            model_name='relatedresult',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='relatedfeatureid', on_delete=django.db.models.deletion.CASCADE, related_name='related_features_related_feature', to='dataloader.SamplingFeature'),
        ),
        migrations.AddField(
            model_name='relatedfeature',
            name='relationship_type',
        ...
        migrations.AddField(
            model_name='relatedfeature',
            name='sampling_feature',
            field=models.ForeignKey(db_column='samplingfeatureid', on_delete=django.db.models.deletion.CASCADE, related_name='related_features_sampling_feature', to='dataloader.SamplingFeature'),
        ),
        migrations.AddField(
            model_name='relatedfeature',
            name='spatial_offset',
