...
class Macroinvertebrate(models.Model):
    ...
    scientific_name = models.CharField(max_length=255)  # i.e.
    common_name = models.CharField(max_length=255)  #
    family_of = models.ForeignKey('Macroinvertebrate', on_delete=models.CASCADE, null=True, blank=True)
...
class LeafPack(models.Model):
    ...
    leaf_pack_count = models.IntegerField()
